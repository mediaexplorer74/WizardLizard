...
namespace GameManager
{
  public class OrcBuilder : IBuilder
  {
    ...
    public void BuildGameObject(Vector2 position)
    {
      ...
      gameObject.AddComponent((Component) new SpriteRenderer(gameObject, "OgreSpriteSheet", 1f));
      ...
      gameObject.AddComponent((Component) new Orc(gameObject));
