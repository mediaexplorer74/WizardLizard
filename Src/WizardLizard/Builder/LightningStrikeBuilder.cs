...
// Type: GameManager.LightningStrikeBuilder
...
namespace GameManager
{
  public class LightningStrikeBuilder : IBuilder
  {
    ...
    public void BuildGameObject(Vector2 position)
    {
      ...
      gameObject.AddComponent((Component) new SpriteRenderer(gameObject, "LightningStrike", 1f));
      gameObject.Transform.Position = position;
      gameObject.AddComponent((Component) new Collider(gameObject));
      gameObject.AddComponent((Component) new LightningStrike(gameObject));
