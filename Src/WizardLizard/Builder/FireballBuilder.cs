...
// Type: GameManager.FireballBuilder
...
namespace GameManager
{
  public class FireballBuilder : IBuilder
  {
    ...
    public void BuildGameObject(Vector2 position)
    {
      ...
      gameObject.AddComponent((Component) new SpriteRenderer(gameObject, "Fireball", 1f));
      ...
      gameObject.AddComponent((Component) new Fireball(gameObject));
