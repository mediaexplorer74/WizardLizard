...
// Type: GameManager.GoblinBuilder
...
namespace GameManager
{
  public class GoblinBuilder : IBuilder
  {
    ...
    public void BuildGameObject(Vector2 position)
    {
      ...
      gameObject.AddComponent((Component) new SpriteRenderer(gameObject, "GoblinSpriteSheet", 1f));
      ...
      gameObject.AddComponent((Component) new Goblin(gameObject));
