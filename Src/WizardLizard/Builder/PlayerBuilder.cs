...
// Type: GameManager.PlayerBuilder
...
namespace GameManager
{
  public class PlayerBuilder : IBuilder
  {
    ...
    public void BuildGameObject(Vector2 position)
    {
      ...
      gameObject.AddComponent((Component) new SpriteRenderer(gameObject, "PlayerSpriteSheet", 1f));
      ...
      gameObject.AddComponent((Component) new Player(gameObject));
